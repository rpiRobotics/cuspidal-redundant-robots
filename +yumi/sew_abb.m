classdef sew_abb
    ...
    methods
        ...
        function [psi, e_r, p_0W, e_x, h_4_0] = fwd_kin(obj, kin, q)
            ...
            e_x = cross(e_r, w) / norm(cross(e_r, w));
        ...
        function J_psi = jacobian(obj, kin, q)
            [~, e_r, p_0W, e_x, h_4_0] = fwd_kin(obj, kin, q);
        ...
        function [e_r, e_x] = inv_kin(obj, p_0W, psi)
            e_r = [0;0;1]; % TODO
