...
% q_A = Q(:,idx_pos(1)); % [-2.0500   -1.3169    1.2948    2.8094    0.6503    1.1827]
% q_B = Q(:,idx_pos(2)); % [1.5082   -1.6661    1.4763    2.9569    2.3055   -2.5998]
